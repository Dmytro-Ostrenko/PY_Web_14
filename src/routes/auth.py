from fastapi import APIRouter, HTTPException, Depends, status, BackgroundTasks, Request, Response, Security
...
async def login(body: OAuth2PasswordRequestForm = Depends(), db: AsyncSession = Depends(get_db)):
    ...
    :return: A dictionary, which is serialized to json
    :doc-author: Trelent
    """
...
async def request_email(body: RequestEmail, background_tasks: BackgroundTasks, request: Request,
    ...
    :param db: AsyncSession: Get the database session
    :return: A dict, but the openapi spec says it should return a requestemailresponse
    :doc-author: Trelent
    """
...
async def request_email(username: str, response: Response, db: AsyncSession = Depends(get_db)):
    """
    The request_email function is used to open the email in the database.
        Args:
            username (str): The name of the user who opened an email.
            response (Response): A response object that will be returned to a client.
    
    :param username: str: Get the username of the user who is requesting to open an email
    :param response: Response: Set the response status code and headers
    :param db: AsyncSession: Get a database session
    :return: A file
    :doc-author: Trelent
    """
