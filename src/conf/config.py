...
class Settings(BaseSettings):
    DB_URL: str = "postgresql+asyncpg://user:password@localhost:5432/hw11"
    ...
    CLD_NAME: str = "diqhrt5ie"
    CLD_API_KEY: int = 264529815539895
    CLD_API_SECRET: str = "E-zYU6dqO6fNFjUibKyYBUq_rDY"
